...
- `rules/architecture-avoid-boolean-props.md` - Don't add boolean props to customize
  behavior
- `rules/architecture-compound-components.md` - Structure as compound components with
  shared context

### State Management (HIGH)

- `rules/state-lift-state.md` - Lift state into provider components
- `rules/state-context-interface.md` - Define clear context interfaces
  (state/actions/meta)
- `rules/state-decouple-implementation.md` - Decouple state management from UI

### Implementation Patterns (MEDIUM)

- `rules/patterns-children-over-render-props.md` - Prefer children over renderX props
- `rules/patterns-explicit-variants.md` - Create explicit component variants
