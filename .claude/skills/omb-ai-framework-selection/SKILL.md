---
name: omb-ai-framework-selection
...
**Skills to invoke next:** `omb-langchain-fundamentals`, `omb-langchain-rag`, `omb-langchain-middleware`
...
**Skills to invoke next:** `omb-langgraph-fundamentals`, `omb-langgraph-hitl`, `omb-langgraph-persistence`
...
**Skills to invoke next:** `omb-deepagents-core`, `omb-deepagents-memory`, `omb-deepagents-orchestration`
