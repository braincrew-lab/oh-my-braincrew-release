...
Write-Host "  1. Initialize in your project:  cd C:\path\to\project; omb init"
Write-Host "  2. Start Claude Code:           claude --plugin-dir $env:USERPROFILE\.omb\plugin"
Write-Host "  3. Run the setup wizard:        /omb setup"
Write-Host ""
Write-Host "Update anytime with:  omb update"
